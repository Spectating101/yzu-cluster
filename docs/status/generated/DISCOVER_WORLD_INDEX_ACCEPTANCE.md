# Discover World Index — acceptance

Accepted product composition for Discover Browse.

- The result index owns the canvas; the procurement process tutorial is not primary UI.
- Results group by decision: **Already in your lab**, **Sources beyond your lab**, **Needs access**.
- The summary exposes owned-vs-beyond-lab scope and one counted Filter disclosure.
