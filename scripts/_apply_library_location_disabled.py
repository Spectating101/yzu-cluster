...
if 'const [locationMode, setLocationMode]' not in s:
...
if 'const browsingPhysicalFolders =' not in s:
...
if 'data-testid="library-location-filter"' not in s:
